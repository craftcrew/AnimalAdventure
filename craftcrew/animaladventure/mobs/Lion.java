...
public class Lion extends EntityTameable 
{
     ...
     *
     */
    public Lion spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        Lion lion = new Lion(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof Lion))
        {
            return false;
        }
        else
        {
            Lion lion = (Lion)par1EntityAnimal;
            return !lion.isTamed() ? false : (lion.isSitting() ? false : this.isInLove() && lion.isInLove());
        }
    }
    ...
    @SideOnly(Side.CLIENT)
    public static class RenderLion extends RenderLiving {
        
        private static final ResourceLocation lionTexture = new ResourceLocation("" + BasicInfo.NAME.toLowerCase(), "/textures/mobs/spider.png");

        public RenderLion(ModelBase par1ModelBase, float par2) {
